			...
			<div class="col-md-5  offset-md-4">
				...
				<div class="card paint-card">
					...
					<div class="card-body">
						...
						<p class="fs-3 text-center">Edit Mentor Details</p>
						...
						<form action="../updateMentor" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Mentor Qualification</label> <input
									...
									class="form-control" value="<%=mt.getQualification()%>">
							</div>
							...
							<div class="mb-3">
								<label class="form-label">Mentor Subject</label> <select
									...
									<option><%=mt.getMentorlist()%></option>
							...
							<div class="mb-3">
								<label class="form-label">Mentor Email</label> <input
									...
									required class="form-control" value="<%=mt.getEmail()%>">
							</div>
							...
							<div class="mb-3">
								<label class="form-label">Mentor Mobile number</label> <input
									...
									class="form-control" value="<%=mt.getMobileno()%>">
							</div>
							...
							<div class="mb-3">
								<label class="form-label">Password</label> <input
									...
									class="form-control" value="<%=mt.getPassword()%>">
							</div>
							
							<input type="hidden" name= "id" value="<%=mt.getId()%>">

							<button type="Submit" class="btn btn-primary col-12">
								<i class="fa fa-pencil me-2" aria-hidden="true"></i>Update
								Mentor Details
							</button>
